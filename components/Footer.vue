<template>
    ...
    <div>
        ...
        <!-- Footer Bottom Start -->
        <div style="text-align:center;" class="bg-gray-800 py-5">

            <div class="container flex justify-between relative items-center md:flex-row flex-col-reverse">

                <p class="text-gray-500 text-sm uppercase font-medium mb-0" style="font-size:0.82rem">© 2022 Technobites<br> Made With <i class="icofont-heart text-primary"></i>  By <a href="https://makemeglobal.live/" class="transition-all hover:text-primary text-white">Makemeglobal -</a><a style="color:#C738E9" href="https://www.linkedin.com/in/yuvraj-jwala/"> YUVRAJ JWALA</a></p>
